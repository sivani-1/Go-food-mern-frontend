...
export default function Home() {
  ...
  return (
    <div>
        <div> <Navbar/> </div>
        <div> 
          {/* <div id="carouselExampleControls" className="carousel slide" data-bs-ride="carousel" style={{objectFit:"contain !important",with:" 5px"}}>
          <div className="carousel-inner" style={{zIndex:"10"}}> */}
              <div className="d-flex justify-content-center mt-5 ">
                <input className="form-control me-2" type="search" placeholder="Search" aria-label="Search" value={search} onChange={(e)=>{setSearch(e.target.value)}} style={{width:"300px"}}/>
